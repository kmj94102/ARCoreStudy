...
object ExtrudedCylinder {
    ...
    fun makeExtrudedCylinder(
        ...
        val submesh = RenderableDefinition.Submesh.builder().setTriangleIndices(triangleIndices).setMaterial(material).build()
    ...
    private fun generateVerticesFromPoints(
        ...
        for (edgeIndex in 0..NUMBER_OF_SIDES) {
            ...
            var uvCoordinate = Vertex.UvCoordinate(uStep * edgeIndex, 0f)
            ...
            uvCoordinate = Vertex.UvCoordinate(uStep * edgeIndex, vHeight)
    ...
    private fun updateEndPointUV(vertices: List<Vertex>) {
        ...
        for (edgeIndex in 0..NUMBER_OF_SIDES) {
            ...
            currentVertex.uvCoordinate = Vertex.UvCoordinate(
    ...
    private fun makeDisk(
        ...
        for (edge in 0..NUMBER_OF_SIDES) {
            ...
            val uvCoordinate = Vertex.UvCoordinate(
